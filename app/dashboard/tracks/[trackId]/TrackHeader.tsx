...
export default function TrackHeader({ track, progress }: Props) {
  ...
  return (
    <header className="rounded-2xl border border-border bg-card/60 p-4 md:p-5">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs text-foreground/80">
          ...
          <button className="rounded-full border border-border bg-card px-3 py-1 text-[11px] font-medium text-foreground hover:border-emerald-500/60">
            View Requirements
          </button>
          <button className="rounded-full border border-border bg-card px-3 py-1 text-[11px] font-medium text-foreground hover:border-emerald-500/60">
